            ...
            <div class="card" style="margin: 10px;"  >
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="terms">
                                        {{ __('Estoy de acuerdo con') }} <a href="#">{{ __('Terminos y Condiciones') }}</a>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="botn btn btn-primary" style="width: 100%;">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <p><a href="{{ url('/login') }}">{{ __('¿Ya tengo Cuenta?') }}</a></p>
                            </div>
                        </div>
                    </form>
                </div>
